...
def processDataset(dataset_name: str, z_slices: int):
    ...
    save_dir = PROJECT_ROOT / "output" / "cuda" / dataset_name
    ...
    gpu_binner = LissajousBinnerCUDA(H, W, z_slices)
    ...
    for i, frame_x, frame_z in frame_gen:
        ...
        count, volume = gpu_binner.process_frame(
        # conunt, volume = XYZbinning_cuda(
